        ...
        <div class="whole">
            ...
            <div v-if="Add" class="add-student-form">
                ...
                <div>
                    ...
                    <div>
                        <input :disabled="bill_obj.name.length == 0" class="form-validate number-only answer" type="text" id="u-p-a" {{-- v-bind:value="Edit.unpaid_previous_account" --}} v-model="Edit.unpaid_previous_account" v-on:keyup="Edit_upa" />
                    </div>
                </div>
                <div>
                    <div>
